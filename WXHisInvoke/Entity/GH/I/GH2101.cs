...
namespace WXHisInvoke.Entity.GH.I
{
    ...
    class GH2101 : BASE_I
    {
        ...
        string GHQD { get; set; }//		1	挂号渠道 Y =医生,Z=自助机 (传空默认为自助机), 原GHLY	INPARA	
        ...
        string WGZFJG { get; set; }//		--	网上挂号支付结果		
        string ZFJG { get; set; }//		--	支付结果 根据不同的支付方式,传入不同结果数据包,支付方式为挂帐时,该值可以为空见值域说明 支付方式(ZFFS)		 	JHZFJG	
